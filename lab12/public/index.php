            ...
            <?php
                ...
                foreach ($showed as $post) { ?>
                    <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
                        ...
                        <a href="/post.php?id=<?php print($post['id']); ?>" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 mb-3">
                            Read more
                       ...
                       ?>
                        <a href="/post.php?id=<?php print($post['id']); ?>">
                            <h5 class="mt-2 text-xl  tracking-tight text-gray-900">Пост создал: <?php print($user ->getData()['username'])?></h5>
                        </a>
                    </div>
                <?php 
                }
